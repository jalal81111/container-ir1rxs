...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ir1rxs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ir1rxs.containers.anotherwebservice.com/
...
```
git clone git@github.com:jalal81111/container-ir1rxs.git
cd container-ir1rxs
```
...
```
docker attach container-ir1rxs
```
